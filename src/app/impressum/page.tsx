                ...
                <div className="container">
                    <div className="legal-content">
                        <div className="alert alert-info">
                            <strong>Demo-Hinweis:</strong> Dies ist ein Platzhalter für das Impressum. In einer echten Anwendung müssen hier die gesetzlich vorgeschriebenen Angaben stehen.
                        </div>
                        ...
                        <p>
                            Berufsbezeichnung: Fahrradhändler / Fahrradmechaniker<br />
